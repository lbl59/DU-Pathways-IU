...
#SBATCH --qos=regular
#SBATCH --job-name=opt_mm4_n2048_IU_seed${JOB}
#SBATCH --output=logs/opt_mm4_n256_IU_seed${JOB}.out
#SBATCH --error=logs/opt_mm4_n256_IU_seed${JOB}.err
...
srun -n 2048 ./SedentoValleySimulation \
  ...
  -v output_raw_IU_fullExp/ -I _bs200 -M 1 \
  -C -1 -O rof_tables_opt_IU/ \
